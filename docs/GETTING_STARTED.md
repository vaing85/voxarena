...
| POST | `/performances/audio` | 🔒 Multipart `audio` (WAV) + `playerId`, `songId`, `mode`. Real pitch **and timing** via the pitch service. Needs `PITCH_SERVICE_URL` + song reference notes. |
